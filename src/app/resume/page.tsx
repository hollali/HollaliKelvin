...
export default function Resume() {
  const sections = [
    ...
    { title: '# Experience', delay: 0.35, content: (
      <>
        {[
          { role: 'Senior Full Stack Developer', company: 'Company Name', period: '2020 - Present', items: [
            'Led development of web applications using React and Node.js',
            'Implemented CI/CD pipelines reducing deployment time by 50%',
            'Mentored junior developers and conducted code reviews',
          ]},
          { role: 'Full Stack Developer', company: 'Previous Company', period: '2018 - 2020', items: [
            'Developed and maintained RESTful APIs',
            'Built responsive UIs with modern JavaScript frameworks',
    ...
    { title: '# Education', delay: 0.45, content: (
      <>
        <div className="text-sm text-[#e0e0e0]">BSc. Computer Science</div>
        <div className="text-xs" style={{ color: 'var(--terminal-accent)' }}>University Name | 2014 - 2018</div>
        <p className="text-xs text-[#666] mt-1">Graduated with honors.</p>
      </>
    )},
  ]
